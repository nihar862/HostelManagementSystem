...
<body>
  ...
  list-style: square inside url("sqpurple.gif");
    ...
    <h3 class="w3-border-bottom w3-border-light-grey w3-padding-16">Regular Room</h3>
  </div>
    
    <header class="w3-display-container w3-content w3-wide" style="max-width:1500px;" id="home">
      <img class="w3-image" src="files/room1.jpg" alt="Architecture" width="500" height="500">
  <ul align="">
  <li>Three Sharing Room</li>
  <li>Television</li>
  <li>Cupboards For Each</li>
  <li>Tables for each student</li>
  <li>Price for Regular Room is 45000/-</li>
</ul></align>
</header>
